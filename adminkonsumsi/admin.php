...
<body>
	...
	<div class="container" method="post">
		...
		<button type="button" name="export" id="export" class="btn btn-primary" style="float:right;">Export to Excel</button>
		<br><br>
		<!-- <select name="sakit" id="sakit" class="form-control" onchange="getData(this.value)">
				...
				<?php
					...
					$i = 1;
						...
						$query2 = "SELECT * FROM vege_vegan order by keterangan desc"; 
    ...
    <script>
      $("#export").click(function(){
        $("#tabel").table2excel({
          name: "Data Konsumsi Peserta",
          filename: "Data Konsumsi Peserta",
          fileext: ".xls"
        });
      });
    </script>
