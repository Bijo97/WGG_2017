...
$sql = "SELECT * FROM contact WHERE kategori = 1 ORDER BY status, id DESC";
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li class="active"><a href="list_contact.php">Jadwal Kegiatan <span class="sr-only">(current)</span></a></li>
            <li><a href="list_contact2.php">Peraturan & Ketentuan</a></li>
