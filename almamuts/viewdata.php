...
<?php
	...
	echo "<br/><br/><br/><center>NAMA :<b> ".$row['nama']."</b></center>";
	echo "<br/><center>NRP  : <b>".$_GET['nrp']."</b></center>";
	?>
	...
	<table class="table">
		<tr>
			<td style="width: 150px;"><center>Jaket</center></td>
			<td style="width: 150px;"><center>Muts</center></td>
		...
		<?php } ?>
			...
			<td style="text-align:center;"><input type="submit" class="form-control btn btn-primary" style="width: 100px; margin: 0 auto;" name="submit" value="Yes"></td>
		</tr>
	</table>
	</div>
	</div>
