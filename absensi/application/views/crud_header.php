	...
	<div class="row-fluid">
		<div class="navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container">
					<a class="brand" href="#">Absensi WGG 2017</a>
					<ul class="nav">
						...
						<li class="dropdown" id="setting">
							<a class="dropdown-toggle" data-toggle="dropdown" href="#">Absensi Rapat Panitia<b class="caret"></b></a>
							<ul class="dropdown-menu">
								<?php
									$q=$this->rapat_model->get_all_rapat();
									foreach($q->result() as $r){?>
										<li><a href="<?= site_url('rapat_masuk');?>/index/<?=$r->id_rapat?>"><?=$r->rapat?> Regis In</a></li>
										<li><a href="<?= site_url('rapat_keluar');?>/index/<?=$r->id_rapat?>"><?=$r->rapat?> Regis Out</a></li>
								<?php }?>
							</ul>
						</li>
						<li class="dropdown" id="setting">
						...
						<li class="dropdown" id="setting">
							<a class="dropdown-toggle" data-toggle="dropdown" href="https://wgg.petra.ac.id/absensi/logout.php">Logout</a>
						</li>
					</ul>
				</div>
			</div>
