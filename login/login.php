...
function validate()
{
	 ...
	 if( name.value == "" )
	 {
	  error = "Harap isi username kartu PAC anda ";
	  alert(error);
	  return false;
	 }
	 ...
	 if( no.value == "" )
	 {
	  error = "Harap isi password kartu PAC anda ";
	  alert(error);
	  return false;
	 }
...
<link rel="shortcut icon" href="../images/logowgg.png" />
	...
	<title>Portal Login WGG 2017</title>
	<meta name="theme-color" content="#1A47C4">
</head>
<body>
<div id="formku" class="container-fluid">
<center><h2>Portal Login Mahasiswa Baru<br> Welcome Grateful Generation 2017</h2></center><br><br>
	<div class="container">
			<div class="panel-body">
			<div class="panel panel-default">
				<form method="post" class="col-12" action="cek.php" onsubmit = "return validate();">
					<div class="form-group">
						<label for="username">Username Kartu PAC:</label>
						<input type="text" name="username" id="username" class="form-control">
					</div>
					<div class="form-group">
						<label for="username">Password Kartu PAC:</label>
