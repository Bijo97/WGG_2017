...
{	
	...
	{
			$real_type=$field_info->crud_type;
			$types_array=array('integer','text','true_false','string','date','datetime','enum','set','relation','relation_n_n','upload_file','hidden','password','readonly','dropdown','multiselect');
...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	{	
		...
		$this->_inline_js("var ajax_relation_url='".$this->getAjaxRelationUrl()."';\n");
		$field_info =$this->relation_n_n[$field_info_type->name];
