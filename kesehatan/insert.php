<?php
	...
	include "connect.php";
		...
		$p53 = $_POST['p53'];
		if(isset($nama) && isset($no_ujian))
		{
			$sql = "INSERT INTO form_kesehatan VALUES ('','".$nama."',".$no_ujian.",'".$nrp."','".$jk."','".$tll."',
			'".$tgl."',".$bb.",".$tb.",'".$alamat."','".$no_telp."','".$no_hp."','".$alamat_sby."','".$nama_wali."','".$alamat_wali."',
			'".$no_telp_wali."','".$no_hp_wali."','".$p1."','".$p2."','".$p3."','".$p4."','".$p5."','".$p6."','".$p7."','".$p8."',
