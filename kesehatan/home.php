...
<script type="text/javascript">
	function validate()
	{
		...
		var telpwali = document.getElementById("telpWali");
		if(telpwali.value=="")
		{
			error = "Anda belum mengisi nomor telepon wali. ";
			alert(error);
			return false;
		}
...
<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
	...
	<h3 style="margin-top: 30px;"><center>Form Kesehatan Mahasiswa Baru<br>Welcome Grateful Generation 2017</center></h3>
		<div class="panel panel-default">
			<div class="panel-body">
				<form action="insert.php" method="post" onsubmit="return validate();">
					<div class="form-group">
						<label>Nama Lengkap</label>
						<input type="text" id="nama" class="form-control" placeholder="Nama Lengkap" name="nama" value="<?php echo $nama; ?>" readonly="true">
					</div>
					<div class="form-group">
						<label>No Ujian</label>
						<input type="number" id="No" class="form-control" placeholder="No Ujian" name="No" value="<?php echo $noujian; ?>" readonly="true">
					</div>
					<div class="form-group">
						<label>NRP</label>
					...
					<div class="form-group">
						...
						<div class="radio">
							<label>
								<input type="radio" name="jeniskelamin" id="jenis1" value="P" checked="checked">
								Perempuan
							</label>
						</div>
						<div class="radio">
					...
					<span class="label label-danger">Data hanya dapat dimasukkan sekali.</span>
